...
export const GithubRepo: React.FC<GithubRepoProps> = ({ list, height }) => {
  return (
    <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[calc(943px-32.5px-${height}px-7rem)] overflow-y-auto`}>
